...
```
The slope decreases from 0.504 to 0.364. Region is therefore a confounder for economy.
...
```
The slope stays quite similar, but $R^2$ increases. That means that `ef_money` is not a confounder.
